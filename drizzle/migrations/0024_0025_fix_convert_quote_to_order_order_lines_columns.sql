-- Fix: convert_quote_to_order inserted into non-existent order_lines columns
-- (product_name, total_excl_vat, total_incl_vat) and omitted the NOT NULL
-- column unit_price_incl_vat. Both overloads are corrected identically.
