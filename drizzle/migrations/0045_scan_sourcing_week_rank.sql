...
REVOKE ALL ON FUNCTION public.scan_sourcing_week_rank(uuid) FROM public, anon;
GRANT EXECUTE ON FUNCTION public.scan_sourcing_week_rank(uuid) TO authenticated;