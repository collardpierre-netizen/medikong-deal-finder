...
BEGIN
  ...
  LOOP
    ...
    -- Identifiants Qogita de l'offre (retrouver l'offre / le vendeur chez Qogita)
    v_qogita_qid := NULL;
    v_qogita_fid := NULL;
    IF v_offer_id IS NOT NULL THEN
      SELECT o.qogita_offer_qid, o.qogita_seller_fid
        INTO v_qogita_qid, v_qogita_fid
    ...
    INSERT INTO public.order_lines (
      ...
      qogita_offer_qid, qogita_seller_fid
    ) VALUES (
...
-- Rattrapage : remplir les lignes de commande existantes depuis leur offre
UPDATE public.order_lines ol
SET qogita_offer_qid = o.qogita_offer_qid,
    qogita_seller_fid = o.qogita_seller_fid
FROM public.offers o
WHERE ol.offer_id = o.id
  AND ol.qogita_offer_qid IS NULL
  AND o.qogita_offer_qid IS NOT NULL;