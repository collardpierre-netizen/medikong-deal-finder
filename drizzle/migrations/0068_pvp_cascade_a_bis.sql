...
LANGUAGE sql STABLE SECURITY DEFINER SET search_path = public AS $$
  -- Cascade : a) APB/PMR fiche → a bis) prix public fichier grossiste (Febelco/CERP, plus récent, Febelco à égalité)
  --           → b) prix conseillé fiche (fabricant/distributeur/manuel) → b) prix conseillé fournisseur autorisé.
  WITH prod AS (
