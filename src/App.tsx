...
const BuyerActivationPage = lazyWithRetry(() => import("./pages/BuyerActivationPage"), "BuyerActivationPage");
...
const AdminProductDuplicates = lazyWithRetry(() => import("./pages/admin/AdminProductDuplicates"), "AdminProductDuplicates");
...
const AdminIntelligenceOverviewPage = lazyWithRetry(() => import("./pages/admin/AdminIntelligenceOverviewPage"), "AdminIntelligenceOverviewPage");
...
const VendorVerifyAttachPage = lazyWithRetry(() => import("./pages/vendor/VendorVerifyAttachPage"), "VendorVerifyAttachPage");
...
const VendorExclusivities = lazyWithRetry(() => import("./pages/vendor/VendorExclusivities"), "VendorExclusivities");
...
const LegacyScanRedirect = lazyWithRetry(() => import("./components/scan/LegacyScanRedirect"), "LegacyScanRedirect");
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/care" element={<LP><LegacyCareRedirect /></LP>} />
            {/* medikong.pro/scan → scan.medikong.pro */}
            <Route path="/scan/*" element={<LP><LegacyScanRedirect /></LP>} />
            <Route path="/scan" element={<LP><LegacyScanRedirect /></LP>} />
            ...
            <Route path="/admin" element={<LP><AdminLayout /></LP>}>
              ...
              <Route path="marges-distribution" element={<LP><AdminMarginDistribution /></LP>} />
            ...
            <Route path="/vendor/verifier-acces" element={<LP><VendorVerifyAttachPage /></LP>} />
