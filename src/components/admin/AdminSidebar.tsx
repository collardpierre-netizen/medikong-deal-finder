...
import { Euro, Handshake, Landmark, ScanLine } from "lucide-react";
...
const sections: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Suivi par commande", path: "/admin/suivi-commande", icon: FileText },
  ...
  },
  {
    ...
    items: [
      ...
      // { label: "Signalements terrain", path: "/admin/scan/signalements", icon: ScanLine }, // publication séparée
