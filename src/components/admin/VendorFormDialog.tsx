      ...
      if (form.create_account && form.email.trim()) {
        const { data, error } = await supabase.functions.invoke("create-vendor-account", {
          body: {
            ...
            margin_split_pct: form.commission_model === 'margin_split' ? form.margin_split_pct : 0,
            fixed_commission_amount: form.commission_model === 'fixed_amount' ? form.fixed_commission_amount : null,
