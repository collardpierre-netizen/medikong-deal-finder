...
const ToastBackdrop = () => {
  ...
  const active = !!toasts && toasts.some((item) => item.data?.nonModal !== true);
    ...
    <>
      ...
      <Sonner
        ...
        toastOptions={{
          ...
          classNames: {
            toast:
              "group toast !rounded-xl !border !px-5 !py-4 !min-w-0 sm:!min-w-[440px] !max-w-[95vw] !shadow-xl group-[.toaster]:bg-background group-[.toaster]:text-foreground group-[.toaster]:border-border",
