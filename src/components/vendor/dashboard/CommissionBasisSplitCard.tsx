  ...
  const rows = [
    {
      ...
      sub: "100% marge (PV − PA)",
      tooltip:
        "Modèle « trading » : MediKong prend 100% de la marge brute (prix de vente − prix d'achat). Utilisé pour les commandes achetées puis revendues par MediKong (souvent lignes admin / RFQ). Techniquement : order_lines.commission_basis = 'margin', commission_rate = 100.",
      value: tradingCents,
    ...
    },
    {
      ...
      tooltip:
        "Modèle marketplace « classique » : MediKong prélève un pourcentage sur le CA HTVA facturé au client (ex. 12%). C'est ce taux qui suit le palier négocié. Techniquement : order_lines.commission_basis = 'ca', commission_rate = % négocié.",
    ...
    },
    {
      ...
      tooltip:
        "Lignes dont la base de commission (commission_basis) n'est pas renseignée en base. Anciennes commandes ou imports sans typage explicite. Contactez le support si le montant est significatif.",
      value: otherCents,
          ...
          <div className="flex items-center gap-1.5">
            ...
            <Tooltip>
              ...
              <TooltipContent side="top" className="max-w-[320px] text-[11px] leading-snug">
                <p className="font-semibold mb-1">Deux modèles de commission MediKong</p>
                <p>
                  <span className="font-semibold">Trading</span> : MediKong prend{" "}
                  <span className="font-semibold">100% de la marge</span> (PV − PA). Le
                  vendeur touche son prix d'achat, MediKong absorbe la marge brute.
                </p>
                <p className="mt-1">
                  <span className="font-semibold">Marketplace / classique</span> : MediKong
                  prélève un <span className="font-semibold">% du CA HTVA</span> (taux
                  négocié, sensible au palier). Le vendeur touche PV − commission.
                </p>
                <p className="mt-1 text-[#8B95A5]">
                  Le palier négocié ne s'applique qu'à la part marketplace.
                </p>
              </TooltipContent>
            </Tooltip>
          </div>
              ...
              <div key={r.key} className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline justify-between gap-2">
                    <span className="text-[12px] font-semibold text-[#1D2530] truncate inline-flex items-center gap-1">
                      {r.label}
                      <Tooltip>
                        <TooltipTrigger className="inline-flex items-center cursor-help text-[#8B95A5] hover:text-[#1D2530] shrink-0">
