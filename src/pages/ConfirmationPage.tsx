  ...
  return (
    <Layout>
      <div className="mk-container py-12 md:py-16 max-w-[800px] mx-auto text-center px-4">
        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-mk-green flex items-center justify-center mx-auto mb-6">
          <Check size={32} className="text-white" strokeWidth={3} />
        </div>
        <h1 className="text-2xl md:text-[32px] font-bold text-mk-green mb-2">Commande confirmee !</h1>
        <p className="text-sm text-mk-sec mb-8">Votre commande a ete confirmee. Vous recevrez un email de confirmation sous peu.</p>

        <div className="bg-mk-alt rounded-lg p-5 md:p-6 mb-6 text-left">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div><span className="text-xs text-mk-sec">Numero commande</span><div className="text-lg md:text-xl font-bold text-mk-navy">MK-2026-00847</div></div>
            ...
            <div className="sm:col-span-2"><span className="text-xs text-mk-sec">Livraison prevue</span><div className="text-sm font-medium text-mk-green flex items-center gap-1"><Truck size={14} /> 28-30 mars 2026</div></div>
          </div>
        </div>
