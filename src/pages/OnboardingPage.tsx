      ...
      if (role === "buyer") {
        ...
        if (!existingCustomer) {
          ...
          if (customerError) {
            ...
            toast.error("Création du compte acheteur impossible", {
              description: customerError.message || "Veuillez réessayer ou contacter le support.",
              duration: 12000,
            });
            setSubmitting(false);
            return;
    ...
    switch (step) {
      ...
      case 2: return (
        <div>
          ...
          <p style={{ fontSize: 13, color: S.sec, marginBottom: 20 }}>Nous vous enverrons un code de vérification à {OTP_LENGTH} chiffres.</p>
