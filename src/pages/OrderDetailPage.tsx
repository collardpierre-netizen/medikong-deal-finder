    ...
    <Layout>
      <div className="mk-container py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-[28px] font-bold text-mk-navy">Commande #{id}</h1>
        ...
        {/* Timeline */}
        <div className="bg-mk-alt rounded-lg p-6 mb-8">
          <div className="flex items-center justify-between">
            {timeline.map((s, i) => (
              <div key={s} className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${i <= currentStep ? "bg-mk-green text-white" : "bg-mk-line text-mk-sec"}`}>
                  {i + 1}
                </div>
                <span className={`text-sm ${i <= currentStep ? "font-bold text-mk-navy" : "text-mk-sec"}`}>{s}</span>
                {i < 3 && <div className={`w-12 h-0.5 ${i < currentStep ? "bg-mk-green" : "bg-mk-line"}`} />}
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Articles */}
        <div className="border border-mk-line rounded-lg overflow-hidden mb-8">
          ...
          {items.map(i => (
            <div key={i.name} className="grid grid-cols-4 gap-3 px-4 py-3 border-t border-mk-line text-sm items-center">
          ...
          <div className="grid grid-cols-4 gap-3 px-4 py-3 border-t border-mk-line bg-mk-alt">
