          ...
          <div className="flex-1 min-w-0">
                  ...
                  <div key={s.name} className="border border-mk-line rounded-lg p-5">
                    ...
                    <div className="bg-mk-mov-bg border border-mk-mov-border rounded-md p-3 mb-3">
                      ...
                      <div className="h-1.5 bg-mk-mov-border rounded-full overflow-hidden">
                        <div className="h-full bg-mk-amber rounded-full" style={{ width: "27%" }} />
                      </div>
                    </div>
            ...
            <div className="mt-8 space-y-2">
              {accordeonItems.map((a, i) => (
                <div key={a.title} className="border border-mk-line rounded-lg">
                  <button onClick={() => setOpenAccordion(openAccordion === i ? null : i)} className="flex items-center justify-between w-full p-4">
                    ...
                    <ChevronDown size={16} className={`text-mk-sec transition-transform ${openAccordion === i ? "rotate-180" : ""}`} />
                  </button>
                  {openAccordion === i && (
                    <div className="px-4 pb-4 text-sm text-mk-sec animate-slideDown">{a.desc}</div>
                  )}
                </div>
              ))}
            </div>
            ...
            <div className="mt-8">
              ...
              {techSpecs.map(([k, v], i) => (
                <div key={k} className={`flex justify-between py-2.5 px-3 text-sm ${i % 2 === 0 ? "bg-mk-alt" : ""}`}>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="text-2xl font-bold text-mk-green mt-1">+{margin}%</div>
                </div>
              </div>
            </div>

            {/* Seller CTA */}
            <div className="mt-8 border-2 border-dashed border-mk-line rounded-lg p-6 text-center">
