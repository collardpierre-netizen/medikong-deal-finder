 ...
 * pour les Edge Functions (Deno). Miroir strict de
 * `src/lib/contract/mandat-facturation-template.ts`.
 *
 * Toute évolution doit être appliquée aux DEUX fichiers en simultané pour
 * garantir l'identité du PDF généré côté client (aperçu) et serveur (signé).
 */
