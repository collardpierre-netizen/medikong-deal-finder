...
const SAMPLE_PROJECT_URL = "https://medikong.lovable.app"
...
const handler = createAuthEmailHandler({
  ...
  emails: {
    signup: {
      subject: `Confirmez votre adresse e-mail — ${SITE_NAME}`,
      render: (data) =>
    ...
    invite: {
      subject: `Vous êtes invité(e) à rejoindre ${SITE_NAME}`,
      render: (data) =>
    ...
    email_change: {
      subject: `Confirmez votre changement d'adresse e-mail — ${SITE_NAME}`,
      render: (data) =>
