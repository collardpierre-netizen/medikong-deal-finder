...
BEGIN
  ...
  LOOP
    ...
    IF v_existing_token IS NULL THEN
      ...
      INSERT INTO public.vendor_order_tokens (sub_order_id, order_id, vendor_id, order_number, token)
      VALUES (v_sub_id, _order_id, v_rec.vendor_id, v_order.order_number, v_token);
    ELSE
