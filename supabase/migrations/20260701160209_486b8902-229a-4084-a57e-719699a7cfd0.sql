...
BEGIN
  ...
  -- customers guard (note: is_active column doesn't exist on customers; trigger bug tracked separately)
  INSERT INTO public.customers (id, is_verified, credit_limit, customer_type, payment_terms_days)
  VALUES (_cust_id, false, 0, 'pharmacie', 30);
  ...
  IF _admin_uid IS NOT NULL THEN
    ...
    INSERT INTO public.customers (id, is_verified, credit_limit, customer_type)
    VALUES (_cust_id, false, 0, 'pharmacie');
