...
BEGIN
  ...
  INSERT INTO public.customers (id, company_name, email, is_verified, credit_limit, customer_type, payment_terms_days)
  VALUES (_cust_id, 'Guard Test Co', concat('guard-c-', _cust_id::text, '@example.test'), false, 0, 'pharmacy', 30);
  ...
  VALUES (_vendor_id, 'Guard Test', concat('guard-v-', _vendor_id::text, '@example.test'),
  ...
  IF _admin_uid IS NOT NULL THEN
    ...
    INSERT INTO public.customers (id, company_name, email, is_verified, credit_limit, customer_type)
    VALUES (_cust_id, 'Guard Test Admin', concat('guard-adm-', _cust_id::text, '@example.test'), false, 0, 'pharmacy');
