...
BEGIN
  ...
  INSERT INTO public.profiles (id, user_id, full_name) VALUES (_profile_id, _profile_id, 'Guard Test');

  BEGIN UPDATE public.profiles SET price_level_code = 'VIP' WHERE id = _profile_id;
  ...
  BEGIN UPDATE public.profiles SET full_name = 'Renamed' WHERE id = _profile_id;
