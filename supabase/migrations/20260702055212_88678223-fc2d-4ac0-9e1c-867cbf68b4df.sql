CREATE OR REPLACE FUNCTION public.enqueue_qogita_resync_batch(_batch_size integer DEFAULT 500, _mode qogita_resync_mode DEFAULT 'daily_stale_refresh'::qogita_resync_mode)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
