...
BEGIN
  ...
  VALUES (gen_random_uuid(), _marker || '_fc', _customer, 'confirmed', 200.00, 242.00, true, _year_start + interval '12 days')
  ...
  VALUES (gen_random_uuid(), _marker || '_ts', _customer, 'confirmed', 300.00, 363.00, true, _year_start + interval '13 days')
  ...
  VALUES (gen_random_uuid(), _marker || '_hd', _customer, 'delivered', 400.00, 484.00, true, _year_start + interval '14 days')
  ...
  VALUES (gen_random_uuid(), _marker || '_dl', _customer, 'delivered', 250.00, 302.50, now(), _year_start + interval '15 days')
  ...
  -- (a) Réplique SQL exacte des filtres du hook useVendorMonthlyDashboard
  ...
  -- (b) RPC canonique — on impersonne le propriétaire du vendeur le temps de l'appel
