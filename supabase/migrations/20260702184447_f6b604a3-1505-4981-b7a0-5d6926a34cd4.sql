...
BEGIN
  ...
  -- 1) VALIDE : line delivered → order.status = 'delivered'
  INSERT INTO public.orders (id, order_number, customer_id, status, subtotal_excl_vat, total_incl_vat, created_at)
  VALUES (gen_random_uuid(), _marker || '_ok', _customer, 'delivered', 500, 605, _year_start + interval '10 days')
  RETURNING id INTO _o_valid;
  INSERT INTO public.order_lines (order_id, vendor_id, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_rate, line_total_excl_vat, line_total_incl_vat, fulfillment_status)
  VALUES (_o_valid, _vendor, 1, 500, 605, 21, 500, 605, 'delivered');

  -- 2) EXCLU : cancelled (line + order)
  INSERT INTO public.orders (id, order_number, customer_id, status, subtotal_excl_vat, total_incl_vat, created_at)
  ...
  INSERT INTO public.order_lines (order_id, vendor_id, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_rate, line_total_excl_vat, line_total_incl_vat, fulfillment_status)
  VALUES (_o_cancelled, _vendor, 1, 100, 121, 21, 100, 121, 'cancelled');

  -- 3) EXCLU : is_forecast=true (statut recalculé → processing, filtré par is_forecast)
  ...
  INSERT INTO public.order_lines (order_id, vendor_id, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_rate, line_total_excl_vat, line_total_incl_vat, fulfillment_status)
  VALUES (_o_forecast, _vendor, 1, 200, 242, 21, 200, 242, 'delivered');
  ...
  INSERT INTO public.order_lines (order_id, vendor_id, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_rate, line_total_excl_vat, line_total_incl_vat, fulfillment_status)
  VALUES (_o_test, _vendor, 1, 300, 363, 21, 300, 363, 'delivered');
  ...
  INSERT INTO public.order_lines (order_id, vendor_id, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_rate, line_total_excl_vat, line_total_incl_vat, fulfillment_status)
  VALUES (_o_hidden, _vendor, 1, 400, 484, 21, 400, 484, 'delivered');
  ...
  INSERT INTO public.order_lines (order_id, vendor_id, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_rate, line_total_excl_vat, line_total_incl_vat, fulfillment_status)
  VALUES (_o_deleted, _vendor, 1, 250, 302.50, 21, 250, 302.50, 'delivered');

  -- 7) EXCLU : hors fenêtre calendar_year
  INSERT INTO public.orders (id, order_number, customer_id, status, subtotal_excl_vat, total_incl_vat, created_at)
  ...
  INSERT INTO public.order_lines (order_id, vendor_id, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_rate, line_total_excl_vat, line_total_incl_vat, fulfillment_status)
  VALUES (_o_prior, _vendor, 1, 999, 1208.79, 21, 999, 1208.79, 'delivered');

  -- (a) Filtres du hook useVendorMonthlyDashboard rejoués en SQL
  ...
  -- (b) RPC canonique (impersonation propriétaire vendeur)
