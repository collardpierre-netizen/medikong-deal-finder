DROP FUNCTION IF EXISTS public.offers_publication_guard();
...
BEGIN
  ...
  -- la conformité est portée par le vendeur de référence de la vente
  -- (distributeur autorisé + mandat signé), pas par le vendeur affiché.
