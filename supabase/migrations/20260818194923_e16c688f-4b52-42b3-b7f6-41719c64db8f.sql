...
BEGIN
  SELECT
    ...
    offers.is_active AS o_is_active
  INTO o
  FROM public.offers
...
GRANT EXECUTE ON FUNCTION public.resolve_effective_commission(uuid) TO anon, authenticated, service_role;